...
poetry run scrapy crawl minutes -a start_date=2020-12-01 -a end_date=2020-12-08 -a speech=false -a text=true -a overwrite=false -a elasticsearch=https://localhost:9200
